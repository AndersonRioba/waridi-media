...
export default function FaqsCreate() {
    ...
    return (
        <AdminLayout title="Add Studio FAQ">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-[#5C5850] mt-0.5">
                            Formulate a common client question and authoritative answer.
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-2xl border border-[#E8DFC8] space-y-6 shadow-xs">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. How far in advance should I book my session?"
