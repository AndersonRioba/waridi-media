...
export default function LivestreamEdit({ event }: LivestreamEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        title: event.title || '',
        client_name: event.client_name || '',
        description: event.description || '',
        scheduled_at: event.scheduled_at ? event.scheduled_at.substring(0, 16) : '',
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/livestream/${event.id}`);
    };

    return (
        <AdminLayout title={`Edit Livestream: ${event.title}`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="live">Live Now (Featured on Public Site)</option>
