            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1 rounded-full text-xs font-medium transition-all ${
                                            data.tag_ids.includes(tag.id)
                                                ...
                                                : 'bg-[#FBF6EC] border border-[#E8DFC8] text-[#5C5850]'
                                        }`}
                                    >
                                        {tag.name}
                                    </button>
                    ...
                    <div className="flex items-center justify-end gap-4">
                        <Link
                            href="/admin/projects"
                            className="px-6 py-2.5 rounded-xl border border-[#E8DFC8] text-xs font-semibold text-[#1A1A1A]"
                        >
                            Cancel
                        </Link>
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-8 py-2.5 rounded-xl text-xs font-semibold bg-[#141414] text-white hover:bg-[#C9A227] transition-all"
                        >
